...
private enum ApiRequests {
    case getMoviesList(searchTitle: String)
    case getMovie(id: String)
    
    private var baseURL: URL? {
        let urlString = String("http://www.omdbapi.com/?apikey=4a8f0e16&t&")
...
final class NetworkManager {
    ...
    func getMoviesList(with searchKeyword: String, completionHandler: @escaping (([Movie])))
